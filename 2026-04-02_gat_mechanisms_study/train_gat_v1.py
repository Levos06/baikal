...
def train():
    print(f"Starting GATv1 mechanism study on {DEVICE}")
    model = GATv1_Res(21, 2).to(DEVICE)
    ...
    log_file = os.path.join(PROJECT_DIR, "train_v1.log")
    ...
    for i, batch in enumerate(train_loader):
        ...
        if (i + 1) % VIRTUAL_EPOCH_SIZE == 0:
            ...
            if epoch % 50 == 0:
                torch.save(model.state_dict(), f"{PROJECT_DIR}/checkpoints_v1/model_v1_{epoch}.pt")
