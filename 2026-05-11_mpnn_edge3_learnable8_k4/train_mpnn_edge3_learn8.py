...
PROJECT_DIR = "/home/levos/experiments/2026-05-11_mpnn_edge3_learnable8_k4"
BATCH_SIZE = 48
NUM_WORKERS = 4
TOTAL_EPOCHS = 1000
...
def train():
    ...
    log_file = os.path.join(PROJECT_DIR, "train_mpnn_edge3_learn8_k4.log")
    ...
    for i, batch in enumerate(train_loader):
        ...
        if (i + 1) % VIRTUAL_EPOCH_SIZE == 0:
            ...
            if epoch % 100 == 0:
                torch.save(
                    model.state_dict(),
                    f"{PROJECT_DIR}/checkpoints/model_mpnn_edge3_learn8_k4_{epoch}.pt",
                )
            epoch += 1
