...
PROJECT_DIR = "/home/levos/experiments/2026-04-03_gat_fully_connected_last_layer"
...
def train():
    print(f"Starting FC-Last-Layer Experiment on {DEVICE}")
    ...
    log_file = os.path.join(PROJECT_DIR, "train_fc.log")
    ...
    for i, batch in enumerate(train_loader):
        ...
        if (i + 1) % VIRTUAL_EPOCH_SIZE == 0:
            ...
            if epoch % 100 == 0: torch.save(model.state_dict(), f"{PROJECT_DIR}/checkpoints/model_fc_{epoch}.pt")
            epoch += 1
