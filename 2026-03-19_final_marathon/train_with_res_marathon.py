...
def train():
    ...
    print(f"Device: {device} | MARATHON 2000 | WITH RES")
    ...
    # Load checkpoint
    checkpoint_path = f"{project_dir}/checkpoints/model_res_marathon_150.pt"
    ...
    for batch in train_loader:
        ...
        if batch_count % virtual_epoch_size == 0:
            ...
            if epoch % 50 == 0:
                torch.save(model.state_dict(), f"{project_dir}/checkpoints/model_res_marathon_{epoch}.pt")
                # Plot progress
                ...
                plt.savefig(f"{project_dir}/plots/metrics_res_marathon.png"); plt.close()
