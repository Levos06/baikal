...
PROJECT_DIR = "/home/levos/experiments/2026-05-11_mpnn_master_vertex_edge12_fc_master_k4"
...
def train():
    ...
    log_file = os.path.join(PROJECT_DIR, "train_mpnn_master_edge12_k4.log")
    ...
    for i, batch in enumerate(train_loader):
        ...
        if (i + 1) % VIRTUAL_EPOCH_SIZE == 0:
            ...
            if epoch % 100 == 0:
                torch.save(
                    model.state_dict(),
                    f"{PROJECT_DIR}/checkpoints/model_mpnn_master_edge12_k4_{epoch}.pt",
                )
            epoch += 1
