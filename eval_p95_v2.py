...
# 1. 2026-04-15_gat_fc_last_k4
sys.path.append('/home/levos/experiments/2026-04-15_gat_fc_last_k4')
import train_fc_last_k4
train_fc_last_k4.get_complete_edge_index = fast_get_complete_edge_index

# 2. 2026-04-23_gat_cos_sim_beta07
...
# 3. 2026-04-24_gat_cos_sim_beta07_k4
...
# 4. 2026-05-05_general_mpnn_k4
sys.path.append('/home/levos/experiments/2026-05-05_general_mpnn_k4')
import train_general_mpnn
train_general_mpnn.get_complete_edge_index = fast_get_complete_edge_index

# 5. 2026-04-22_gat_fc_last_k_scaling (k=16)
...
def eval_model(model, loader, add_feat_func, num_batches=200):
    model.eval()
    all_labels, all_probs = [], []
    with torch.no_grad():
        for i, batch in enumerate(loader):
            if i >= num_batches: break
            batch = add_feat_func(batch.to(DEVICE))
...
def main():
    models_to_eval = [
        {
            "name": "GATv2 FC-Last-Layer (k=4)",
            "model": train_fc_last_k4.GATv2_FCLast(21, 2).to(DEVICE),
            "ckpt": "/home/levos/experiments/2026-04-15_gat_fc_last_k4/checkpoints/model_fc_last_k4_1000.pt",
            "dataset": train_fc_last_k4.MediumDataset('val', k=4),
            "add_feat": train_fc_last_k4.add_features_21_norm
        },
        {
        ...
        {
            "name": "General MPNN (Mean Aggr) + k=4",
            "model": train_general_mpnn.MPNN_FCLast(21, 2).to(DEVICE),
            "ckpt": "/home/levos/experiments/2026-05-05_general_mpnn_k4/checkpoints/model_mpnn_k4_1000.pt",
            "dataset": train_general_mpnn.MediumDataset('val', k=4),
            "add_feat": train_general_mpnn.add_features_21_norm
        },
        {
